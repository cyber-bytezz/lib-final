        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-sm w-full overflow-hidden">
            ...
            <div className="p-10 pt-12 space-y-6">
              <div><p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Asset Information</p><p className="text-sm font-black text-slate-900 leading-tight">{selectedTx.bookName}</p><p className="text-[10px] font-mono text-violet-600 font-bold mt-1"># {selectedTx.bookId}</p></div>
